    ...
    <div class="login-register-wrap container dp-flex">
        <div class="login-field">
            ...
            <form action="" class="login-form">
                <input type="text" name="email-phonenumber" id="" placeholder="Email/SĐT">
                <input type="text" name="password" id="" placeholder="Mật khẩu">
                <label for="remember-login" class="dp-flex"><input type="checkbox" name="remember-login" id="remember-login">Ghi nhớ đăng nhập</label>
                <button type="submit" class="btn btn__extra-btn">Đăng nhập</button>
            </form>
        </div>
        <div class="register-wrap">
            ...
            <a href="" class="btn btn__extra-btn">Đăng ký</a>
        </div>
    </div>
