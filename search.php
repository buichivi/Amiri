...
<?php 
    ...
    if(isset($_GET['minPrice']) && $_GET['minPrice'] != NULL) {
        ...
        list($productList, $prod_number) = $prod->searchProductWithFilter($keyword, $minPrice, $maxPrice, $saleOption, $sort);
    }
            ...
            <!-- <form action="" method="post"> -->
                <div class="filter-group">
                    ...
                    <div class="filter-btn-group">
                        <a href="?keyword=" class="btn btn__primary-btn disable-filter-btn">Bỏ lọc</a>
                        ...
                        <script>
                            ...
                            filterBtn.addEventListener('click', function(e) {
                                ...
                                this.setAttribute("href", `?keyword=<?=$keyword?>&minPrice=${minPrice}&maxPrice=${maxPrice}&sales=${saleOption}`)
                            })
                        </script>
                    </div>
                </div>
                    ...
                    <div class="product-list dp-flex">
                        ...
                        <?php 
                            if(!isset($_GET['minPrice']) || $_GET['minPrice'] == NULL) {
                                ...
                                list($productList, $prod_number) = $prod->searchProduct($keyword, $sort);
                            }
                            if ($productList) {
